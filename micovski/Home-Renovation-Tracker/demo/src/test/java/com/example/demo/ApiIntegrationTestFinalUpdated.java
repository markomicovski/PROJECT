...
@SpringBootTest(classes = TestConfig.class) // Specify the configuration class
public class ApiIntegrationTestFinalUpdated {

    private static final Logger logger = LoggerFactory.getLogger(ApiIntegrationTestFinalUpdated.class);
