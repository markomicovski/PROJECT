document.addEventListener('DOMContentLoaded', () => {
    const tasksKey = 'living-room-tasks';
    const progressKey = 'living-room-progress';

    const defaultTasks = [
        { text: 'Paint the walls', completed: false },
        { text: 'Install new lighting fixtures', completed: false },
        { text: 'Replace the carpet', completed: false },
        { text: 'Hang wall art', completed: false },
        { text: 'Purchase new furniture', completed: false },
    ];
    ...
    const updateProgress = () => {
        ...
        if (typeof updateDashboardProgress === 'function') {
            updateDashboardProgress('living-room');
        }
    };
