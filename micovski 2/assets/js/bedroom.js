document.addEventListener('DOMContentLoaded', () => {
    const tasksKey = 'bedroom-tasks';
    const progressKey = 'bedroom-progress';

    const defaultTasks = [
        { text: 'Paint the walls', completed: false },
        { text: 'Install new flooring', completed: false },
        { text: 'Buy and arrange new furniture', completed: false },
        { text: 'Add decorative lighting', completed: false },
        { text: 'Organize the closet', completed: false },
    ];
    ...
    const updateProgress = () => {
        ...
        if (typeof updateDashboardProgress === 'function') {
            updateDashboardProgress('bedroom');
        }
    };
